    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="card">
            <img src="{{ $student->avatarUrl() }}" class="card-img-top w-50"  alt="...">
            {{-- <div class="card-body">
              <h5 class="card-title">{{ ucfirst($student->nom) }} {{ ucfirst($student->prenom) }}</h5>
              <p class="card-text">{{ $student->matricule }}</p>
            </div> --}}
          </div>
        </div>
        <div class="col-md-4">
