...
<div class="container-fluid">
    <div class="brand-logo d-flex align-items-center justify-content-between">
        <h5 class="card-title fw-semibold mb-4">{{ __('Gestion des Années Scolaires') }}</h5>
        <a href="{{ Route('school_year.create') }}" class="btn btn-info btn-dm">
            {{ __('Ajout d\'année scolaire') }}
        </a>
    </div>
    @if(session('error'))
